...
import static ru.netology.data.Data.getFormWithNotEnoughNumbersInCard;

public class NotEnoughNumbersInCardByCredit extends TestUI {
    ...
    //Сценарий 1.
    @Test
    public void testWithNotEnoughNumberInCardPayByCredit() {
