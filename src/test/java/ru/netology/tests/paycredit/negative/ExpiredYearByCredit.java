...
import static ru.netology.data.Data.getFormWithExpiredYearCard;

public class ExpiredYearByCredit extends TestUI {
    ...
    //Сценарий 1.
    @Test
    public void testWithExpiredYearCardByCredit() {
        var cardData = getFormWithExpiredYearCard();
        cardEntryForm.completedPaymentForm(cardData);
        cardEntryForm.waitCardExpired();
    }
}
