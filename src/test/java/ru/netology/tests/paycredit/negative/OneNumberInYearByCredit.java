...
import static ru.netology.data.Data.getFormWithOneNumberInYear;

public class OneNumberInYearByCredit extends TestUI {
    ...
    //Сценарий 1.
    @Test
    public void testWithWithOneNumberInYearByCredit() {
        var cardData = getFormWithOneNumberInYear();
