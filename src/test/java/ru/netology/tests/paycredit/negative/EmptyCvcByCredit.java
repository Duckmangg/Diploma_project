...
import static ru.netology.data.Data.getFormWithEmptyCvc;

public class EmptyCvcByCredit extends TestUI {
    ...
    //Сценарий 1.
    @Test
    public void testWithEmptyCvcByCredit() {
        var cardData = getFormWithEmptyCvc();
