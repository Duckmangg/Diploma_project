...
import static ru.netology.data.Data.getFormWithInvalidMonth;

public class InvalidMonthByCredit extends TestUI {
    ...
    //Сценарий 1.
    @Test
    public void testWithInvalidMonthPayByCredit() {
