...
import static ru.netology.data.Data.getFormWithNameInCyrillic;

public class CyrillicInNameFieldByCredit extends TestUI {
    ...
    //Сценарий 1.
    @Test
    public void testWithCyrillicInTheNameFieldByCredit() {
        var cardData = getFormWithNameInCyrillic();
