...
import static ru.netology.data.Data.getFormWithEmptyCardNumber;

public class EmptyCardByCredit extends TestUI {
    ...
    //Сценарий 1.
    @Test
    public void testWithEmptyCardNumberPayByCredit() {
